...
InlineLexer.prototype.output = function (src) {
    ...
    while (src) {
        ...
        if (cap = this.rules.autolink.exec(src)) {
            ...
            out += this.renderer.link(href, null, text, true);
            continue;
        }
...
Renderer.prototype.image = function (href, title, text) {
    ...
    href = href.replace(imageSizeRE, function (source, _width, _height) {
        width = _width;
        height = _height;
        return '';
    });
